...
final int     MooreRad=2;       //Radius of extended Moore neib.
...
void setup()
{
  size(600, 620); //squre canvas with status line
...
void syncStep() // uses global WorldNew,WorldOld //Synchronous step a la classic CA
{
  for (int i=0; i<WorldSide; i++)
