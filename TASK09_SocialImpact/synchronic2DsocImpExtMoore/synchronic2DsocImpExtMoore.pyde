...
MaxStrength=100
'''constant int'''
MooreRad=3       #Radius of extended Moore neib.

FR=5  #desired simulation speed
...
def syncStep(): # Any globals modified? 
  global WorldOld,WorldNew #Synchronous step a la classic CA
  '''block:'''
  for i in range(0,WorldSide,1): # loop over variable "i" Patt#2
...
## @date 2024-12-01 (https://github.com/borkowsk/bookProcessingEN/tree/main/08_2D_cellular/synchronic)
