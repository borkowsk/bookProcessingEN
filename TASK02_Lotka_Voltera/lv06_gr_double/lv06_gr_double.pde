...
final float Tlimit=1000;//Time limit expected to be 2/3 of width
...
for(double T=0;T<Tlimit;T+=Tstep)// double TIME used as stearing variable!
{
  ...
  //Visualisation
  float Xf=(float)X,Yf=(float)Y,Tf=(float)T;//float mirrors of variables because of graphics requairements
