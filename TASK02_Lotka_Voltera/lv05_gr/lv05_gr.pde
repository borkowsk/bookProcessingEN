 ...
 * About loop: https://stackoverflow.com/questions/7267226/range-for-floats
*/
...
final float gamma=beta/10.0; //the growth of predators depends on the number of prey
