...
{
  void   initializeModel(); // to be implemented. 
  void   changeState(); // to be implemented. 
  void   makeStatistics(); // to be implemented. 
  void   modelFullStep(); // to be implemented. 
  float  getTimeStep(); // to be implemented. 
};
