...
class singiel:  #singiel:
  ...
  def __INIT__(self):
    self.r  =0.0  #treat as private     ##float field 
    self.al  =0.0  #treat as private     ##float field 
    self.x1  =0.0  #treat as private     ##float field 
    self.x2  =0.0  #treat as private     ##float field 
    # fc:4
...
## Translated by pde2pyde Wed, 11 Dec 2024 00:13:26 +0100
